...
>![image](https://user-images.githubusercontent.com/5351277/6e84c11e-fa15-47db-863a-3decf7a46b78.png)
...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/myshwfh/rssdzz7890) 
...
如出现错误，可以多尝试几次，待部署完成后页面底部会显示`Your app was successfully deployed` 
  ...
  * 默认协议密码为`da99ef37-637a-4290-93d4-91e8b0de1f69`，WS路径为$UUID-[vmess|vless|trojan|ss|socks]格式

### 客户端
* **务必替换所有的`xxx.herokuapp.com`为heroku分配的项目域名**  
* **务必替换所有的`da99ef37-637a-4290-93d4-91e8b0de1f69`为部署时设置的UUID,建议更改,不要每个人都一样**  
...
* 端口：443
* 默认UUID：da99ef37-637a-4290-93d4-91e8b0de1f69
* vmess额外id：0
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 伪装域名：xxx.workers.dev(CF Workers反代地址)
* 路径：/50cf7657-23ca-4064-b485-7a81b78107e2-vless // 默认vless使用(/自定义UUID码-vless)，vmess使用(/自定义UUID码-vmess)
* 底层传输安全：tls
* 跳过证书验证：false
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "c4d50e77-6e67-4be8-a94f-d99c3bfad4e6"
    ],
    "websocket": {
        "enabled": true,
        "path": "/223486ad-43c7-4a77-9149-018aff9cc63e-trojan",
...
* 端口: 443
* 密码：44bd225f-9252-4a25-8503-62f3ff27dece
* 加密：chacha20-ietf-poly1305
* 插件程序：xray-plugin_windows_amd64.exe  //需将插件https://github.com/shadowsocks/xray-plugin/releases下载解压后放至shadowsocks同目录
* 插件选项: tls;host=xxx.herokuapp.com;path=/b1bfb7ef-fad9-4f88-bfe1-a3bb469cd91d-ss
```
</details>
...
* [CloudflareST](https://github.com/myshwfh/CloudflareST) `OpenWrt推荐-速度较快`
* [cf-autoupdate](https://github.com/myshwfh/cf-autoupdate) `OpenWrt推荐`
